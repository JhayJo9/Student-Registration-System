 ...
 * @author JhayJTheGosu
 */
public class TestingImage extends javax.swing.JFrame {
    ...
    private void lbl_exitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseClicked
        //lbl_exit.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1)); // 5-pixel blue border
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestingImage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestingImage().setVisible(true);
            }
        });
    }
